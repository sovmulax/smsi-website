          ...
          <div class="col-12">
            <nav>
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lorem ipsum dolor sit amet, consectetur
                  adipiscing elit.</li>
              </ol>
            </nav>
          </div><!-- /.col-12 -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="post-item mb-0">
              ...
              <div class="post__body pb-0">
                ...
                <div class="post__meta d-flex align-items-center mb-20">
                  <span class="post__meta-date">20 Janvier 2022</span>
                  <a class="post__meta-author" href="#">Pr KOUAMÉ Kanga</a>
                </div><!-- /.blog-meta -->
            ...
            <div class="widget-nav d-flex justify-content-between mb-40">
              <a href="#" class="widget-nav__prev d-flex flex-wrap">
                ...
                <div class="widget-nav__content">
                  <span>Autre blog</span>
                  <h5 class="widget-nav__ttile mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h5>
                </div>
              </a><!-- /.widget-prev  -->
            ...
            <div class="blog-author d-flex flex-wrap mb-70">
              ...
              <div class="blog-author__content">
                <h6 class="blog-author__name">Pr KOUAMÉ Kanga</h6>
                <p class="blog-author__bio">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consequat
                  suscipit lorem a mollis.
          ...
          <div class="col-sm-12 col-md-12 col-lg-4">
            <aside class="sidebar">
              <div class="widget widget-posts">
                <h5 class="widget__title">Autres blogs</h5>
                <div class="widget__content">
                  ...
                  <div class="widget-post-item d-flex align-items-center">
                    ...
                    <div class="widget-post__content">
                      <span class="widget-post__date">19 Septembre 2024</span>
                      <h4 class="widget-post__title"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit.</a>
                      </h4>
                  ...
                  <div class="widget-post-item d-flex align-items-center">
                    ...
                    <div class="widget-post__content">
                      <span class="widget-post__date">7 Juillet 2023</span>
                      <h4 class="widget-post__title"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit.</a>
                      </h4>
                    </div><!-- /.widget-post-content -->
                  ...
                  <div class="widget-post-item d-flex align-items-center">
                    ...
                    <div class="widget-post__content">
                      <span class="widget-post__date">13 March 2023</span>
                      <h4 class="widget-post__title"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit.</a>
                      </h4>
                    </div><!-- /.widget-post-content -->
