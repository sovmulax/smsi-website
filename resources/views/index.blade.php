              ...
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                <div class="slide__content">
                  <h2 class="slide__title">
                    Prévenons ensemble les cancers cutanés
                  </h2>
                  <p class="slide__desc">
                    Ensemble, nous pouvons réduire le risque de cancers
                    cutanés chez les personnes atteintes d’albinisme en leur
                    fournissant les soins et les ressources nécessaires pour
                    se protéger efficacement contre les dangers du soleil.
                  </p>
                  <ul class="features-list list-unstyled mb-0 d-flex flex-wrap">
                    ...
                    <li class="feature-item">
                      ...
                      <h2 class="feature__title">Sensibilisation</h2>
                    </li>
                    <!-- /.feature-item-->
                    <!-- feature item #2 -->
                    <li class="feature-item">
                      ...
                      <h2 class="feature__title">Prévention</h2>
                    </li>
                    <!-- /.feature-item-->
                    <!-- feature item #3 -->
                    <li class="feature-item">
                      ...
                      <h2 class="feature__title">Soins</h2>
                    </li>
                    <!-- /.feature-item-->
                    <!-- feature item #4 -->
                    <li class="feature-item">
                      ...
                      <h2 class="feature__title">Soutien</h2>
                    </li>
                    <!-- /.feature-item-->
                  </ul>
                  <!-- /.features-list -->
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                <div class="slide__content">
                  <h2 class="slide__title">
                    Soutenez les personnes atteintes d’albinisme.
                  </h2>
                  <p class="slide__desc">
                    Aidez-nous à offrir des consultations gratuites, des
                    traitements spécialisés et du soutien aux personnes
                    atteintes d’albinisme en Côte d’Ivoire, en améliorant leur
                    qualité de vie et en luttant contre la stigmatisation.
                  </p>
                  <ul class="features-list list-unstyled mb-0 d-flex flex-wrap">
                    <!-- feature item #1 -->
                    <li class="feature-item">
          ...
          <div class="col-sm-12 col-md-12 col-lg-7 offset-lg-1">
            <div class="heading-layout2">
              <h3 class="heading__title mb-60">
                ...
                par la Prévention et le Soutien
              </h3>
            </div>
            <!-- /heading -->
          </div>
            ...
            <div class="text-with-icon">
              ...
              <div class="text__content">
                <p class="heading__desc font-weight-bold color-secondary mb-30">
                  Le Secours Médico-Social Ivoirien (SMSI) s’engage à prévenir
                  les cancers cutanés chez les personnes atteintes d’albinisme
                  en Côte d’Ivoire.
                </p>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="about__text bg-white">
              <p class="heading__desc mb-30">
                En plus de la prévention, SMSI conduit des recherches sur les lésions cutanées chez les personnes
                atteintes d’albinisme et développe de nouveaux traitements et méthodes de prévention. L’organisation
                collecte et redistribue du matériel médical pour équiper les centres de santé en milieu rural,
                améliorant ainsi les soins de santé primaires.
              </p>
              <p class="heading__desc mb-30">
                SMSI offre également un soutien psychologique et social aux personnes atteintes d’albinisme pour les
                aider à surmonter la stigmatisation et l’isolement. L’organisation développe des partenariats avec des
                ONG, des institutions médicales et des gouvernements pour renforcer ses capacités et mobiliser des
                ressources. Grâce à des programmes de soutien social, SMSI améliore la qualité de vie des personnes
                atteintes d’albinisme en Côte d’Ivoire.
              </p>
              <ul class="list-items list-unstyled">
                <li>
                  Collecte et redistribution de matériel médical aux centres
                  de santé ruraux.
                </li>
                <li>
                  Offrir un soutien psychologique aux personnes atteintes
                  d’albinisme.
                </li>
                <li>Conduite de recherches sur les lésions cutanées.</li>
              </ul>
            </div>
          </div>
          <!-- /.col-lg-6 -->
        ...
        <div class="row mb-100">
          ...
          <div class="col-sm-9 col-md-9 col-lg-6">
            <p class="heading__desc font-weight-bold color-white mb-30">
              Nous offrons une large gamme de soins et de soutien à nos patients, depuis le diagnostic jusqu’au
              traitement et à la réhabilitation.
            </p>
          </div>
          <!-- /.col-lg-6 -->
        </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">Prévention des Cancers Cutanés</h4>
              </div>
            </div>
            <!-- /.feature-item -->
          </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">Recherche et Développement</h4>
              </div>
            </div>
            <!-- /.feature-item -->
          </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">Collecte et Distribution de Matériel Médical</h4>
              </div>
            </div>
            <!-- /.feature-item -->
          </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">Sensibilisation et Éducation</h4>
              </div>
            </div>
            <!-- /.feature-item -->
          </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">Soins de Santé Primaires</h4>
              </div>
            </div>
            <!-- /.feature-item -->
          </div>
            ...
            <div class="feature-item">
              ...
              <div class="feature__content">
                ...
                <h4 class="feature__title">
                  Soutien aux Personnes Atteintes d’Albinisme
                </h4>
              </div>
            </div>
            <!-- /.feature-item -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-7">
            <div class="contact-panel mb-50">
              <form class="contact-panel__form" method="post" action="assets/php/contact.php" id="contactForm">
                <div class="row">
                  <div class="col-sm-12">
                    <h4 class="contact-panel__title">Réserver un créneau</h4>
                  </div>
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      <i class="icon-news form-group-icon"></i>
                      <input type="text" class="form-control" placeholder="Nom & Prénom" id="contact-name" name="contact-name"
                        required />
                    </div>
                  </div>
                  <!-- /.col-lg-6 -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            <div class="heading heading-light mb-30">
              ...
              <p class="heading__desc">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consequat suscipit lorem a mollis. Phasellus
                pellentesque nec nibh nec sodales. In vel vehicula diam, a faucibus risus. Cras quis ultrices purus.
              </p>
            </div>
            <!-- /.text__block -->
            <!-- /.carousel -->
    ...
    <section class="blog-grid pb-50">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-40">
              <h2 class="heading__subtitle">Newsletter</h2>
              <h3 class="heading__title">Récents Blogs</h3>
            </div>
            <!-- /.heading -->
          </div>
          <!-- /.col-lg-6 -->
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="post-item">
              ...
              <div class="post__body">
                <div class="post__meta-cat bg-transparent">
                </div>
                <!-- /.blog-meta-cat -->
                <div class="post__meta d-flex">
                  <span class="post__meta-date">30 Juillet 2024</span>
                  <a class="post__meta-author" href="#">John Doe</a>
                </div>
